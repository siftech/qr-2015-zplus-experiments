...
%       \includegraphics[width=.7\textwidth]{figures/funnel-bw.pdf} }{%
%     \includegraphics[width=.7\textwidth]{figures/funnel.pdf}} \\
%     \ifthenelse{\boolean{blackAndWhite}}{%
%         \includegraphics[width=.7\textwidth]{figures/funnel-graph-bw} }{%
%             \includegraphics[width=.7\textwidth]{figures/funnel-graph} } 
%   \end{tabular}
%   \centering
%   \caption{Scyllarus workload reduction~\anoncite{goldman:09Scyllarus}.}
