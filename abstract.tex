...
%% WONTFIX - Robert, should we move the ``of Goldszmidt and Pearl'' up
%% to the first mention of \zplus ?
%% I don't think so: I think that introducing subordinate phrases like that
%% makes the topic sentence lose focus. We give them credit; that's all we need
%% to do.
\begin{abstract}
...
% However,
% it is difficult to draw \emph{general} conclusions about an intrusion detection
% approach based on
% field testing, since variables are not systematically controlled.
